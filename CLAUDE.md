...
- **Next:** Slice 7b is **done on `slice-7-personas-profile-redesign`** (2026-06-11) — awaiting the user's manual browser pass of the two persona modes, then **merge to master** (user pushes — local master is ahead of `origin/master`). Then the remaining migration backlog: **Chrome extension** (Slice 8), **public-pages redesign**, **Google OAuth**, **email reminders** (`docs/deferred-tasks.md`).
