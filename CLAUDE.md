...
- **Next:** Slice 7 (7a+7b) is **merged to master** (7b merge `e75ecb2`, 2026-06-11; browser-passed with UX/AI-resilience fixes folded in — user pushes, local master is ahead of `origin/master`). Remaining migration backlog: **Chrome extension** (Slice 8), **public-pages redesign**, **Google OAuth**, **email reminders** (`docs/deferred-tasks.md`).
