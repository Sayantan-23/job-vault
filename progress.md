...
- [ ] **Next: Slice 8 — Chrome extension.** Then the backlog: public-pages redesign, Google OAuth, email reminders (`docs/deferred-tasks.md`). Deferred inside 7c: tone/length presets, job-URL scrape into the paste form, job-free generic letters.
