...
│   ├── middleware/
│   │   └── auth.global.ts            # Route guard: public(/,/web/**), auth(/app/auth/**), protected(/app/**)
│   ├── pages/
│   │   ├── index.vue                 # Public landing page (web layout)
│   │   ├── web/                      # Public pages (faq, about, privacy, terms, contact)
│   │   └── app/                      # Auth (/app/auth/**) + protected pages (/app/dashboard, etc.)
│   ├── plugins/
...
18. **Create `pages/index.vue`** — Public landing page (web layout); app pages under `pages/app/`
