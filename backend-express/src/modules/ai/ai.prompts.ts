...
In bullet and summary text, wrap the most impactful 1-3 phrases in **double asterisks** to bold them for emphasis. Keep bullets achievement-oriented and concise. Do not include markdown fences.`
