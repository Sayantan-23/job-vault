    ...
    <Pressable
      ...
      <View className="flex-row items-start justify-between gap-3">
        <View className="flex-row items-start gap-3 min-w-0 flex-1">
          <View className="size-10 rounded-xl bg-primary/10 items-center justify-center flex-shrink-0">
            <Icon icon={UserRound} size={18} className="text-primary" />
          </View>
          <View className="min-w-0 flex-1">
            <Text numberOfLines={1} className="font-serif text-[18px] leading-tight font-bold text-foreground">
              {persona.name}
            </Text>
        ...
        <View className="flex-row items-center gap-2 flex-shrink-0">
          <Pressable
            ...
            <Icon icon={Pencil} size={15} className="text-foreground" />
          </Pressable>
          <Pressable
            accessibilityRole="button"
      ...
      {/* Summary Box */}
      <View className="mt-3.5 rounded-xl bg-secondary/40 p-3 border border-border/40">
        <Text
          numberOfLines={2}
