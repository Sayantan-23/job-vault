 ...
 *  - `lucide-react-native` joins the transform allowlist and `.mjs` joins the
 *    transform map: under the `react-native` export condition lucide resolves to
 *    an ESM `.mjs` bundle, which the preset neither allows nor knows how to parse.
