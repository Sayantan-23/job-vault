// A deliberately small Markdown model shared by the cover-letter preview (HTML)
// and the PDF document, so the two renderings can never drift. Cover letters use
// a constrained grammar: paragraphs (blank-line separated), soft line breaks
// (single newline — the contact header), `**bold**`, and `[text](url)` links.
